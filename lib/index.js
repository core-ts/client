...
var GenericClient = (function (_super) {
  ...
  GenericClient.prototype.formatResultInfo = function (result, ctx) {
  ...
  GenericClient.prototype.insert = function (obj, ctx) {
    var t = this;
    if (t._metamodel) {
  ...
  GenericClient.prototype.update = function (obj, ctx) {
    var t = this;
  ...
  GenericClient.prototype.patch = function (obj, ctx) {
    var t = this;
    var url = t.serviceUrl;
    var ks = t.keys();
    if (ks && ks.length > 0) {
  ...
  GenericClient.prototype.delete = function (id, ctx) {
    var t = this;
...
var SearchClient = (function () {
  function SearchClient(http, serviceUrl, pmodel, metaModel, config, ignoreDate, searchGet) {
    this.http = http;
    this.serviceUrl = serviceUrl;
    this.config = config;
  ...
  SearchClient.prototype.postOnly = function (s) {
    return false;
  };
  SearchClient.prototype.formatSearch = function (s) {
  };
  SearchClient.prototype.makeUrlParameters = function (s, fields, excluding) {
    return param(s, fields, excluding);
  };
  SearchClient.prototype.keys = function () {
    return this._keys;
  };
  SearchClient.prototype.search = function (s, limit, offset, fields) {
    var t = this;
    t.formatSearch(s);
    var c = t.config;
    ...
    var s1 = optimizeSearchModel(s, sp, sl, sfl);
    if (t.postOnly(s1)) {
...
var ApprClient = (function () {
  ...
  ApprClient.prototype.approve = function (id, ctx) {
    ...
    return t.http.get(url).then(function (r) { return r; }).catch(function (err) {
      if (!t.diffStatus) {
        throw err;
      }
      if (err) {
...
var ViewSearchClient = (function (_super) {
  __extends(ViewSearchClient, _super);
  function ViewSearchClient(http, serviceUrl, model, config, ignoreDate, searchGet, metamodel) {
  ...
  ViewSearchClient.prototype.keys = function () {
    return this.viewWebClient.keys();
  };
  ViewSearchClient.prototype.metadata = function () {
    return this.viewWebClient.metadata();
  };
  ViewSearchClient.prototype.all = function (ctx) {
    return this.viewWebClient.all(ctx);
  };
  ViewSearchClient.prototype.load = function (id, ctx) {
    return this.viewWebClient.load(id, ctx);
  };
  return ViewSearchClient;
}(SearchClient));
exports.ViewSearchClient = ViewSearchClient;
var GenericSearchClient = (function (_super) {
  ...
  function GenericSearchClient(http, serviceUrl, model, config, ignoreDate, searchGet, metamodel) {
    var _this = _super.call(this, http, serviceUrl, model, metamodel, config, ignoreDate, searchGet) || this;
    _this.genericWebClient = new GenericClient(http, serviceUrl, model, config, ignoreDate, _this._metamodel);
    _this.metadata = _this.metadata.bind(_this);
    _this.keys = _this.keys.bind(_this);
    _this.all = _this.all.bind(_this);
    _this.load = _this.load.bind(_this);
...
var GenericSearchDiffApprClient = (function (_super) {
  ...
  GenericSearchDiffApprClient.prototype.diff = function (id, ctx) {
    return this.diffWebClient.diff(id, ctx);
  };
  GenericSearchDiffApprClient.prototype.approve = function (id, ctx) {
    return this.diffWebClient.approve(id, ctx);
  };
  GenericSearchDiffApprClient.prototype.reject = function (id, ctx) {
    return this.diffWebClient.reject(id, ctx);
  };
