...
function mapSearchModel(s) {
  if (!json_1.resources.config) {
    return s;
  }
  var c = json_1.resources.config;
  var x = s;
...
exports.mapSearchModel = mapSearchModel;
...
var ViewWebClient = (function () {
  function ViewWebClient(serviceUrl, http, pmodel, metamodel) {
...
var GenericWebClient = (function (_super) {
  ...
  function GenericWebClient(serviceUrl, http, pmodel, metamodel) {
    var _this = _super.call(this, serviceUrl, http, pmodel, metamodel) || this;
          ...
          case 2:
            ...
            if (err_2) {
              ...
              if (data.status === 404 || data.status === 410) {
                x = 0;
                if (json_1.resources.status) {
                  x = json_1.resources.status.NotFound;
                }
                return [2, x];
              }
                ...
                x = -1;
                if (json_1.resources.status) {
                  x = json_1.resources.status.VersionError;
                }
                return [2, x];
              }
            }
...
var SearchWebClient = (function () {
  function SearchWebClient(serviceUrl, http, pmodel, metaModel, searchGet) {
    this.serviceUrl = serviceUrl;
    this.http = http;
  ...
  SearchWebClient.prototype.search = function (s, ctx) {
    return __awaiter(this, void 0, void 0, function () {
      var _i, _a, key, s1, s2, postSearchUrl, res, keys2, searchUrl, res, params, searchUrl, res, postSearchUrl, res;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            this.formatSearch(s);
            ...
            s1 = optimizeSearchModel(s);
            s2 = mapSearchModel(s1);
            if (!this.postOnly(s2)) return [3, 2];
            postSearchUrl = this.serviceUrl + '/search';
            return [4, this.http.post(postSearchUrl, s2)];
          case 1:
            res = _b.sent();
            return [2, buildSearchResultByConfig(s, res, json_1.resources.config, this._metamodel)];
          case 2:
...
function buildSearchResultByConfig(s, res, c, metamodel) {
...
var DiffWebClient = (function () {
  function DiffWebClient(serviceUrl, http, pmodel, metaModel) {
    this.serviceUrl = serviceUrl;
    this.http = http;
...
var ApprWebClient = (function () {
  function ApprWebClient(serviceUrl, http, pmodel, metaModel) {
    this.serviceUrl = serviceUrl;
    this.http = http;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            err_7 = _b.sent();
            if (!json_1.resources.diff) {
              throw err_7;
            }
            if (err_7) {
              data = (err_7 && err_7.response) ? err_7.response : err_7;
              if (data.status === 404 || data.status === 410) {
                return [2, json_1.resources.diff.NotFound];
              }
              else if (data.status === 409) {
                return [2, json_1.resources.diff.VersionError];
              }
            }
            if (json_1.resources.diff.Error) {
              return [2, json_1.resources.diff.Error];
            }
            else {
              throw err_7;
            }
...
var DiffApprWebClient = (function (_super) {
  ...
  function DiffApprWebClient(serviceUrl, http, model, metaModel) {
    ...
    _this.http = http;
    _this.apprWebClient = new ApprWebClient(serviceUrl, http, model, _this._metaModel);
...
var ViewSearchDiffApprWebClient = (function (_super) {
  ...
  function ViewSearchDiffApprWebClient(serviceUrl, http, model, metamodel, searchGet) {
    var _this = _super.call(this, serviceUrl, http, model, metamodel, searchGet) || this;
    _this.diffWebClient = new DiffApprWebClient(serviceUrl, http, model, _this._metamodel);
