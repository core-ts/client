...
var ViewWebClient = (function () {
  function ViewWebClient(serviceUrl, http, pmodel, metamodel, ignoreDate) {
...
var GenericWebClient = (function (_super) {
  ...
  function GenericWebClient(serviceUrl, http, pmodel, metamodel, status, ignoreDate) {
    var _this = _super.call(this, serviceUrl, http, pmodel, metamodel, ignoreDate) || this;
    _this.status = status;
...
var DiffWebClient = (function () {
  function DiffWebClient(serviceUrl, http, pmodel, metaModel, ignoreDate) {
    this.serviceUrl = serviceUrl;
    this.http = http;
...
var ApprWebClient = (function () {
  function ApprWebClient(serviceUrl, http, pmodel, metaModel, diffStatus, ignoreDate) {
    this.serviceUrl = serviceUrl;
    this.http = http;
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (err_7) {
              ...
              if (data.status === 404 || data.status === 410) {
                return [2, this.diffStatus.NotFound];
              }
              else if (data.status === 409) {
                return [2, this.diffStatus.VersionError];
              }
            }
...
var DiffApprWebClient = (function (_super) {
  ...
  function DiffApprWebClient(serviceUrl, http, model, metaModel, diffStatus, ignoreDate) {
    var _this = _super.call(this, serviceUrl, http, model, metaModel) || this;
    _this.serviceUrl = serviceUrl;
    _this.http = http;
    _this.apprWebClient = new ApprWebClient(serviceUrl, http, model, _this._metaModel, diffStatus, ignoreDate);
...
var ViewSearchWebClient = (function (_super) {
  ...
  function ViewSearchWebClient(serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) {
    var _this = _super.call(this, serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) || this;
    _this.viewWebClient = new ViewWebClient(serviceUrl, http, model, _this._metamodel, ignoreDate);
...
var GenericSearchWebClient = (function (_super) {
  ...
  function GenericSearchWebClient(serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) {
    var _this = _super.call(this, serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) || this;
    _this.genericWebClient = new GenericWebClient(serviceUrl, http, model, _this._metamodel, config, ignoreDate);
    _this.metadata = _this.metadata.bind(_this);
    _this.keys = _this.keys.bind(_this);
    _this.all = _this.all.bind(_this);
    _this.load = _this.load.bind(_this);
...
var ViewSearchDiffApprWebClient = (function (_super) {
  ...
  function ViewSearchDiffApprWebClient(serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) {
    var _this = _super.call(this, serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) || this;
    _this.diffWebClient = new DiffApprWebClient(serviceUrl, http, model, _this._metamodel, config, ignoreDate);
...
var GenericSearchDiffApprWebClient = (function (_super) {
  ...
  function GenericSearchDiffApprWebClient(serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) {
    var _this = _super.call(this, serviceUrl, http, model, metamodel, config, ignoreDate, searchGet) || this;
    _this.diffWebClient = new DiffApprWebClient(serviceUrl, http, model, _this._metamodel, config, ignoreDate);
    _this.diff = _this.diff.bind(_this);
    _this.approve = _this.approve.bind(_this);
