    ...
    return __awaiter(this, void 0, void 0, function(){
      ...
      return __generator(this, function(_b){
        switch (_b.label){
          ...
          case 2:
            err_1 = _b.sent();
            if (err_1 && (err_1.status === 404 || err_1.status === 410)){
              return [2, null];
            }
            throw err_1;
          case 3: return [2];
...
var GenericWebClient = (function(_super){
  ...
  GenericWebClient.prototype.update=function(obj, ctx){
    return __awaiter(this, void 0, void 0, function(){
      var url, ks, _i, ks_3, name, res, err_2, x, x;
      return __generator(this, function(_a){
        switch (_a.label){
          case 0:
            _a.trys.push([0, 2, , 3]);
          ...
          case 2:
            err_2 = _a.sent();
            if (err_2){
              if (err_2.status === 404 || err_2.status === 410){
                x = 0;
                return [2, x];
              }
              else if (err_2.status === 409){
                x = -1;
                return [2, x];
              }
            }
  ...
  GenericWebClient.prototype.patch=function(obj, ctx){
    return __awaiter(this, void 0, void 0, function(){
      var url, ks, _i, ks_4, name, res, err_3, x, x;
      return __generator(this, function(_a){
        switch (_a.label){
          case 0:
            _a.trys.push([0, 2, , 3]);
          ...
          case 2:
            err_3 = _a.sent();
            if (err_3){
              if (err_3.status === 404 || err_3.status === 410){
                x = 0;
                return [2, x];
              }
              else if (err_3.status === 409){
                x = -1;
                return [2, x];
              }
            }
  ...
  GenericWebClient.prototype.delete=function(id, ctx){
    return __awaiter(this, void 0, void 0, function(){
      var url, ks, _i, ks_5, key, res, err_4;
      return __generator(this, function(_a){
        switch (_a.label){
          case 0:
            _a.trys.push([0, 2, , 3]);
          ...
          case 2:
            err_4 = _a.sent();
            if (err_4 && (err_4.status === 404 || err_4.status === 410)){
              return [2, 0];
            }
            else {
              throw err_4;
      ...
      return __generator(this, function(_b){
        switch (_b.label){
          ...
          case 2:
            err_6 = _b.sent();
            if (err_6){
              if (err_6.status === 404 || err_6.status === 410){
                return [2, Status.NotFound];
              }
              else if (err_6.status === 409){
      ...
      return __generator(this, function(_b){
        switch (_b.label){
          ...
          case 2:
            err_7 = _b.sent();
            if (err_7){
              if (err_7.status === 404 || err_7.status === 410){
                return [2, Status.NotFound];
              }
              else if (err_7.status === 409){
                return [2, Status.VersionError];
              }
            }
            return [2, Status.Error];
