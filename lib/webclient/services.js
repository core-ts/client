...
var GenericWebClient = (function (_super){
  ...
  GenericWebClient.prototype.update=function(obj, ctx){
    return __awaiter(this, void 0, void 0,function(){
      var url, ks, _i, ks_3, name, res, err_1, x, x;
      return __generator(this,function(_a){
        switch (_a.label){
          case 0:
            url = this.serviceUrl;
          ...
          case 3:
            err_1 = _a.sent();
            if (err_1){
              if (err_1.status === 404 || err_1.status === 410){
                x = 0;
                return [2, x];
              }
              else if (err_1.status === 409){
                x = -1;
                return [2, x];
              }
            }
  ...
  GenericWebClient.prototype.patch=function(obj, ctx){
    return __awaiter(this, void 0, void 0,function(){
      var url, ks, _i, ks_4, name, res, err_2, x, x;
      return __generator(this,function(_a){
        switch (_a.label){
          case 0:
            url = this.serviceUrl;
  ...
  GenericWebClient.prototype.delete=function(id, ctx){
    return __awaiter(this, void 0, void 0,function(){
      var url, ks, _i, ks_5, key, res, err_3;
      return __generator(this,function(_a){
        switch (_a.label){
          case 0:
            url = this.serviceUrl + '/' + id;
          ...
          case 3:
            err_3 = _a.sent();
            if (err_3 && (err_3.status === 404 || err_3.status === 410)){
              return [2, 0];
            }
            else {
              throw err_3;
      ...
      return __generator(this,function(_b){
        switch (_b.label){
          ...
          case 3:
            err_5 = _b.sent();
            if (err_5){
              if (err_5.status === 404 || err_5.status === 410){
                return [2, Status.NotFound];
              }
              else if (err_5.status === 409){
